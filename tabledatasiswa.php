<table border="1">
    ...
    while ($tampil = mysqli_fetch_array($ambildata)){
        ...
        <tr>
          ...
          <td>$tampil[alamat]</td>
          <td><a href='halaman_admin.php?page=hapussiswa&id=$tampil[id]'>Hapus</a></td>
          <td><a href='halaman_admin.php?page=editsiswa&id=$tampil[id]'>Edit</a></td>
        </tr>";
        $no++;
    }
    ?>
...
if(isset($_GET['kode'])){
    ...
    mysqli_query($koneksi,"delete from data_siswa where nisn='$_GET[id]'");
